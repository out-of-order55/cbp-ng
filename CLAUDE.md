...
每次修改文件后，，如果是修改计数器，需要运行./compile cbp -DPREDICTOR="my_bp<>" -DVERBOSE -DPERF_COUNTERS -DCHEATING_MODE -DUPDATEALTONWEAKMISP -DFREE_FANOUT，如果是正常修改，请运行./compile cbp -DPREDICTOR="my_bp<>" -DVERBOSE，保证没有错误，否则继续修改
